...
# Config
input_dir = "etc/Academic_281020_102051_parts"
...
def main():
    ...
    parts = sorted(glob.glob(os.path.join(input_dir, "Academic_281020_102051_part_*.pdf")))
    current_key_idx = 0
    ...
    for pdf_path in parts:
        ...
        if content:
            ...
            # Don't exit, try next file. We can re-run for failed files later.
