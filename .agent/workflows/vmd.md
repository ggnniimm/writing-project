...
- **Blind Transformation Danger:** การเปลี่ยน `5` -> `๕` ทันทีโดยไม่ดู PDF คือกับดัก! ถ้าต้นฉบับคือ `๖` เท่ากับเรา "ประทับตราความผิด" ให้ดูถูกต้อง
- **ต้องตรวจสอบ PDF ทุกครั้ง** เพื่อยืนยัน **ค่า (Value)** ก่อนยืนยันรูปแบบ (Format)
