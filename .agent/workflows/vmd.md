...
> [!IMPORTANT]
> **กฎเหล็ก (Iron Rule):** การตรวจสอบเลขอารบิค **ต้อง** ทำโดยการเทียบกับไฟล์ PDF ต้นฉบับเท่านั้น!
> **ห้าม** แก้ไขโดยใช้การเดาหรือความคุ้นเคยโดยเด็ดขาด (Do not do anything else absolutely).
> หากพบตัวเลขที่สงสัย ให้เปิด PDF ดูจุดนั้นทันที
